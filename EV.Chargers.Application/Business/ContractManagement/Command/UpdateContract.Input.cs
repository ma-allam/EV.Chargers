...
{
    public class UpdateContractHandlerInput : BaseRequest, IRequest<UpdateContractHandlerOutput>
    {
        public UpdateContractHandlerInput() { }
        public UpdateContractHandlerInput(Guid correlationId) : base(correlationId) { }
        [Required]
