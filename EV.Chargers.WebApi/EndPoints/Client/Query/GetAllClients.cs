...
namespace EV.Chargers.WebApi.EndPoints.Client.Query
{
    ...
    .WithActionResult<GetAllClientsEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "GetAllClients", Description = "GetAllClients ", OperationId = "EV.Chargers.WebApi.EndPoints.Client.Query.GetAllClients", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Client" })]
