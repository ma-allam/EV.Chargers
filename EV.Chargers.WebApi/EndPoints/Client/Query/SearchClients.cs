...
namespace EV.Chargers.WebApi.EndPoints.Client.Query
{
    ...
    .WithActionResult<SearchClientsEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "SearchClients", Description = "SearchClients ", OperationId = "EV.Chargers.WebApi.EndPoints.Client.Query.SearchClients", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Client" })]
