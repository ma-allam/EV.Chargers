...
namespace EV.Chargers.WebApi.EndPoints.Client.Query
{
    ...
    .WithActionResult<GetClientByIdEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "GetClientById", Description = "GetClientById ", OperationId = "EV.Chargers.WebApi.EndPoints.Client.Query.GetClientById", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Client" })]
