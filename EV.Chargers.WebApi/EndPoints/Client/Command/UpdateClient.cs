...
namespace EV.Chargers.WebApi.EndPoints.Client.Command
{
    ...
    .WithActionResult<UpdateClientEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "UpdateClient", Description = "UpdateClient ", OperationId = "EV.Chargers.WebApi.EndPoints.Client.Command.UpdateClient", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Client" })]
