...
namespace EV.Chargers.WebApi.EndPoints.Order.Command
{
    ...
    .WithActionResult<UpdateOrderEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "UpdateOrder", Description = "UpdateOrder ", OperationId = "EV.Chargers.WebApi.EndPoints.Order.Command.UpdateOrder", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Order" })]
