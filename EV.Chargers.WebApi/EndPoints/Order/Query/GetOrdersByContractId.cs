...
namespace EV.Chargers.WebApi.EndPoints.Order.Query
{
    ...
    .WithActionResult<GetOrdersByContractIdEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "GetOrdersByContractId", Description = "GetOrdersByContractId ", OperationId = "EV.Chargers.WebApi.EndPoints.Order.Query.GetOrdersByContractId", Tags = new[] { "EV.Chargers.WebApi.EndPoints.Order" })]
