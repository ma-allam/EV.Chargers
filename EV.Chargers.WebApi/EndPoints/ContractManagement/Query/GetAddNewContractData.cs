...
namespace EV.Chargers.WebApi.EndPoints.ContractManagement.Query
{
    ...
    .WithActionResult<GetAddNewContractDataEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "GetAddNewContractData", Description = "GetAddNewContractData ", OperationId = "EV.Chargers.WebApi.EndPoints.ContractManagement.Query.GetAddNewContractData", Tags = new[] { "EV.Chargers.WebApi.EndPoints.ContractManagement" })]
