...
namespace EV.Chargers.WebApi.EndPoints.ContractManagement.Command
{
    ...
    .WithActionResult<UpdateContractEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "UpdateContract", Description = "UpdateContract ", OperationId = "EV.Chargers.WebApi.EndPoints.ContractManagement.Command.UpdateContract", Tags = new[] { "EV.Chargers.WebApi.EndPoints.ContractManagement" })]
