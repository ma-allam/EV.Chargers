...
namespace EV.Chargers.WebApi.EndPoints.UploadDownloadAttach
{
    ...
    .WithActionResult<UploadAttachmentEndPointResponse>
    {
        ...
        [SwaggerOperation(Summary = "UploadAttachment", Description = "UploadAttachment ", OperationId = "EV.Chargers.WebApi.EndPoints.UploadDownloadAttach.UploadAttachment", Tags = new[] { "EV.Chargers.WebApi.EndPoints.UploadDownloadAttach" })]
